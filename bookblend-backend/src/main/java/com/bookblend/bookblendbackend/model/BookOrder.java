...
public class BookOrder {
    ...
    private List<BookOrderQuantities> quantities = new ArrayList<>();

    /**
     * Gets the quantities ordered.
     * @return The quantities.
     */
    public List<BookOrderQuantities> getQuantities() {
        return quantities;
    }
     ...
     */
    public void setQuantities(List<BookOrderQuantities> quantities) {
